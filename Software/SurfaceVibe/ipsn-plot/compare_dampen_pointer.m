...
filename{1} = 'data/drive/dataset/wood24-dampened-swipe.mat';
filename{2} = 'data/drive/dataset/wood24-fingernail-dampened-swipe.mat';
filename{3} = 'data/drive/dataset/wood24-bar1-dampened-swipe.mat';
...
save('compare_pointer.mat','evaluation')