...
filename{1} = 'datasets/wood24-swipe.mat';
filename{2} = 'datasets/wood24-dampened-swipe.mat';
filename{3} = 'datasets/iron24-swipe.mat';
filename{4} = 'datasets/iron24-dampened-swipe.mat';
filename{5} = 'datasets/cement24-swipe.mat';
filename{6} = 'datasets/cement24-dampened-swipe.mat';
filename{7} = 'datasets/stone24-swipe.mat';
filename{8} = 'datasets/stone24-dampened-swipe.mat';
filename{9} = 'datasets/tile16-swipe.mat';
filename{10} = 'datasets/tile16-dampened-swipe.mat';
...
selectedVelocity{3} = 10000;
selectedVelocity{4} = 10000;
selectedVelocity{5} = 17000;
selectedVelocity{6} = 17000;
selectedVelocity{7} = 16000;
selectedVelocity{8} = 16000;
selectedVelocity{9} = 13000;
selectedVelocity{10} = 13000;
...
%             stdoas(:,4) = smooth(t(:,3),0.3,'rloess');
            ...
            if size(validPoints,1) > 5
                ...
                if size(validPoints,1) > 20
                    evaluation{fileIdx, dirIdx, eIdx} = evaluateSwipe(validPoints, [ep1; ep2], s);
                end
            end
...
save('compare_material.mat','evaluation');