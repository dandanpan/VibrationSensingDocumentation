...
filename{1} = 'datasets/wood16-swipe.mat';
filename{2} = 'datasets/wood16-dampened-swipe.mat';
filename{3} = 'datasets/wood24-swipe.mat';
filename{4} = 'datasets/wood24-dampened-swipe.mat';
filename{5} = 'datasets/wood32-swipe.mat';
filename{6} = 'datasets/wood32-dampened-swipe.mat';
filename{7} = 'datasets/wood40-swipe.mat';
filename{8} = 'datasets/wood40-dampened-swipe.mat';

for i = 1:8
    selectedScale{i} = 10;
    selectedVelocity{i} = 20000;
end
% filename{1} = 'data/drive/dataset/wood16-swipe.mat';
% filename{2} = 'data/drive/dataset/wood16-dampened-swipe.mat';
% filename{3} = 'data/drive/dataset/wood24-swipe.mat';
% filename{4} = 'data/drive/dataset/wood24-dampened-swipe.mat';
% filename{5} = 'data/drive/dataset/wood32-swipe.mat';
% filename{6} = 'data/drive/dataset/wood32-dampened-swipe.mat';
% filename{7} = 'data/drive/dataset/wood40-swipe.mat';
% filename{8} = 'data/drive/dataset/wood40-dampened-swipe.mat';
% 
% selectedScale{1} = 5;
% selectedScale{2} = 5;
% selectedScale{3} = 5;
...
% selectedScale{8} = 5;
% 
% selectedVelocity{1} = 22000;% that's 220 m/s
% selectedVelocity{2} = 22000;
% selectedVelocity{3} = 22000;
% selectedVelocity{4} = 22000;
% selectedVelocity{5} = 22000;
% selectedVelocity{6} = 22000;
% selectedVelocity{7} = 22000;
% selectedVelocity{8} = 22000;
...
save('compare_size.mat','evaluation')