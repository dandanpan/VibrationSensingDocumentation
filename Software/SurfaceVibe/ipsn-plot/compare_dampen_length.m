...
filename{1} = 'data/drive/dataset/wood24-short-dampened-swipe.mat';
filename{2} = 'data/drive/dataset/wood24-dampened-swipe.mat';
filename{3} = 'data/drive/dataset/wood24-long-dampened-swipe.mat';
...
for lIdx = 1:3
    lines{lIdx,1} = [20 20+5*lIdx; 20 20-5*lIdx];
    lines{lIdx,2} = [20-5*lIdx/sqrt(2) 20+5*lIdx/sqrt(2); 20+5*lIdx/sqrt(2) 20-5*lIdx/sqrt(2)];
    lines{lIdx,3} = [20-5*lIdx 20; 20+5*lIdx 20];
    lines{lIdx,4} = [20-5*lIdx/sqrt(2) 20-5*lIdx/sqrt(2); 20+5*lIdx/sqrt(2) 20+5*lIdx/sqrt(2)];
    lines{lIdx,5} = [20 20-5*lIdx; 20 20+5*lIdx];
    lines{lIdx,6} = [20+5*lIdx/sqrt(2) 20-5*lIdx/sqrt(2); 20-5*lIdx/sqrt(2) 20+5*lIdx/sqrt(2)];
    lines{lIdx,7} = [20+5*lIdx 20; 20-5*lIdx 20];
    lines{lIdx,8} = [20+5*lIdx/sqrt(2) 20+5*lIdx/sqrt(2); 20-5*lIdx/sqrt(2) 20-5*lIdx/sqrt(2)];
end
...
save('compare_length.mat','evaluation')