...
save('tmp.mat','x_tr','y_tr','trace_random');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% training data loading and test data generation
load tmp.mat
...
system('rm *.svm model predictions trans_predictions tmp.mat');
end
