...
gID = 1;
cID = 1;
save('baseline_svm_poly.mat','resultsSummary','crossValid',...
...
for gID = 1 : 5
    for cID = 1 : 5
        for crossValid = 1 : 4
            ...
            svmstruct = svmtrain(stepPatternTrainLabel, stepPatternTrain, ['-s 0 -t 1 -b 1 -g ' num2str(gSet(gID)) ' -c ' num2str(cSet(cID)) ]);
