...
for i = 1:num_exp
    ...
    if num == 1
        ...
        = exp1_1( trace_random, [i num]);
    elseif num == 2
        [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
        = exp1_2( trace_random, [i num]);
    elseif num == 3
        [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
        = exp1_3( trace_random, [i num]);
    elseif num == 4
        [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
        = exp1_4( trace_random, [i num]);
    elseif num == 5
        [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
        = exp1_5( trace_random, [i num]);
    elseif num == 6
        [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
        = exp1_6( trace_random, [i num]);
    elseif num == 7
        [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
        = exp1_7( trace_random, [i num]);
    elseif num == 8
        [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
        = exp1_8( trace_random, [i num]);
    end
