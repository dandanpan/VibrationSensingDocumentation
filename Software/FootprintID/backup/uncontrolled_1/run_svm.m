function [ x_tr,y_tr, pred_multi, y_te, speed_te, acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ] = run_svm( trace_random, ind_speed_tr,  ind_speed_te, semi_layer, x_old, y_old)
