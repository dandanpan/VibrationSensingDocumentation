function [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
    = bias23(num_trace_per, trace_random, exp_id  )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% setpath for library
...
[ x_tr,y_tr, y_pred, y_te, speed_te, acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting, ~, ~  ]...
    = run_svm(num_trace_per,  trace_random, ind_speed_tr, ind_speed_te, 2, x_old, y_old );
...
save(['bias23_' num2str(exp_id) '.mat'],'speed_te','y_pred','y_te','acc','acc_after','confi','pred_table','ind_rm');
