function [ acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ]...
    = bias_fun2( num_trace_per,trace_random,exp_id )
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% num_trace_per = [1 1 1 1 1 1 1 1 1 6];
% num_trace_per = [2 2 2 2 2 2 2 2 2 5];
% num_trace_per = [3 3 3 3 3 3 3 3 3 4];
% 
% num_trace_per = [1 1 1 1 1 6 6 6 6 6];
% num_trace_per = [2 2 2 2 2 5 5 5 5 5];
% num_trace_per = [3 3 3 3 3 4 4 4 4 4];
% 
% num_trace_per = [1 6 6 6 6 6 6 6 6 6];
% num_trace_per = [2 5 5 5 5 5 5 5 5 5];
% num_trace_per = [3 4 4 4 4 4 4 4 4 4];
...
save('tmp.mat','x_tr','y_tr','trace_random','exp_id');
...
for i = ind_trace_te
    ...
    speed_te = speedIDLabel(both_select);
end
...
save(['bias' num2str(exp_id(1)) '_'  num2str(exp_id(2)) '.mat']);
