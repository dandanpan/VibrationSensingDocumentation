    ...
    for speedID = 1%numSpeed
        ...
        for traceID = 1:5%size(traces,1)
            ...
            for stepID = 1 : length(stepEventsIdx)
                ...
                subplot(3,1,2);periodogram(stepSig,[],'twosided',128,Fs);
%                 subplot(3,1,3);
