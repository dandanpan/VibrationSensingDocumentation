function [ clusters, nodeContainsLeave, Z, Y ] = stepSelectionFD( stepSigs, draw, distanceThreshold, Fs )
...
%   Detailed explanation goes here
    ...
    %% normalize step signal energy
    for stepID = 1 : stepNum
        stepSigs(stepID,:) = signalNormalization(stepSigs(stepID,:));
    end
    ...
    for stepID = 1 : stepNum
        ...
        for compareID = stepID + 1 : stepNum
            ...
            [Cxy,f] = mscohere(stepSig1,stepSig2,[],[],[],Fs);
            temp = sum(Cxy)/length(Cxy);
