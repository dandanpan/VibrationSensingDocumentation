...
cookieStep = [];
trainingTime = [];
save('results_cv_near_all.mat','resultsSummary','crossValid',...
    'trainingResultAll','traceResultAll','trainingTime',...
    'matrixAll','cookieStep','numPeople');
...
for crossValid = 1 : 4
    ...
    if trainingFlag == 1
        ...
        for personID = 1 : numPeople
            ...
            % change training speed id based on person id 
            for speedID = speedSequence(trainingSpeedID(personID,:))%speedID = 8;
