configuration_setup;
%% person 1, speed 6, location variation
%% person 3, speed 8, left-right foot different

for personID = 1%1 : numPeople
...
%                     stepVal = traceSig(stepIdx);
%                     if clusterID == 2
%                         scatter(stepIdx./Fs,stepVal+20,'rv');
%                     elseif clusterID == 9
%                         scatter(stepIdx./Fs,stepVal+20,'gv');
%                     end
%                     stepIdx = stepIdxLabel(mask);
%                     stepVal = ones(1, length(stepIdx)).*(clusterID*50);
%                     scatter(stepIdx./Fs,stepVal,'rv');
                end
            end
        end
        hold off;
