...
traceResultAll = [];
crossValid = 1;
save('results_sepa_sepa.mat','resultsSummary','crossValid','traceResultAll');

for crossValid = 1 : 4
    save('results_sepa_sepa.mat','resultsSummary','crossValid','traceResultAll');
    
    clear
    load('results_sepa_sepa.mat');
    configuration_setup;
    for investigatingSpeed = speedSequence
        ...
        if trainingPhaseFlag == 1
            ...
            trainingSpeedID = investigatingSpeed;
            testingSpeedID = investigatingSpeed;
