function [ x_tr,y_tr, pred_multi, y_te, speed_te,x_te_scale, exact_speed_te,acc_nosemi_novoting, acc_nosemi_voting, acc_semi_novoting, acc_semi_voting ,modellibsvm,pred_table_score] = run_svm( trace_random, ind_speed_tr,  ind_speed_te, semi_layer, x_old, y_old)
...
[~, ~, confi1] = svmpredict(y_te, sparse(x_te_scale), m,'-b 0');
