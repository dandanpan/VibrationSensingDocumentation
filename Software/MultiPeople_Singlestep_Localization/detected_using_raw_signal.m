...
% load('./../PorterLab_011719/PorterLab_011719_2p_cross_5.mat'); 
...
figure;
mag=max(sqrt(sum(data_test.^2)));
plot(sqrt(sum(data_test.^2)));

[stepEventsIdx, stepEventsVal, ...
            stepStartIdxArray, stepStopIdxArray, ... 
            windowEnergyArray, noiseMu, noiseSigma, noiseRange ]=PeaksDetection_withinEvent(...
            sqrt(sum(data_test.^2)), sqrt(sum(noise_data.^2)),200,50);
