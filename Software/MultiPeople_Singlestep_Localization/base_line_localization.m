%% The baseline of the localization accuracy
...
% load('./../PorterLab_011719/PorterLab_011719_.mat'); 
% load('./../PorterLab_011719/PorterLab_011719_2p_side_5.mat'); 
load('./../PorterLab_020919/PorterLab_20190210_follow_rep6.mat');

%% for 1 person
% load('./../PorterLab_011719/PorterLab_011719_momo_s_2.mat');
t=data(1,:); % time 
data=data(2:5,:);
% data(2,:)=-data(2,:);
...
% step_detect=[52000,60000;69000,78000;85000,88000;88000,93000;100000,108000;118000,123000;132000,140000;150000,157000]
    ...
    data_test=data(:,stepStartIdxArray(num_step):stepStopIdxArray(num_step));
            ...
            [step_number,tdoa_pairs_all,tdoa_pairs_3channel_all,channel_3numbers_all,...
                scale_4c_all,scale_3c_all]=...
                ShowoneScaleData_baseline(channels,data_test,Fs, noise_data,mode);



if (step_number==0)
    not_detec=[not_detec,num_step];
end
...
%     velocity=linspace(200,600,100);
% elseif(mode==2)
%     velocity=linspace(200,1000,100);
% elseif(mode==3)
%     velocity=linspace(200,600,100);
% end
% %% use four geophones
...
% 
% 
% num_matching=size(tdoa_pairs,1);
...
% filename=['./result_baseline_2p/cross/trial1_3.mat'];
% load(filename);
