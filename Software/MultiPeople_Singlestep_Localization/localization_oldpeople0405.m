...
channels=4;
load('./../../Baptist_ElderExperiments_032819/Baptist_2019_0327_Person1_rep2.mat');
t=data(1,:); % time 
data=data(6:9,:);
...
geophone_number=4;
% geophone_position=[0.1,1.55,0.1,1.55;0.61,1.12,1.63,2.14]; % trial 1
geophone_position=[0.1,1.55,0.1,1.55;2.64,3.15,3.66,4.17]; % trial 2
...
filename='./result_oldpeople/person1_trail2.mat';
load(filename);
