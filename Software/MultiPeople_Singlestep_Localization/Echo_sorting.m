function [d_best, sort_number,best_score] = Echo_sorting(geophone_position,D, d1, cell_distance,already_matching,first_peak)
    ...
    for j=1:peaks_num_everygeophone(3)
        ...
        for k=1:peaks_num_everygeophone(4)
            ...
            if(check==1)
                ...
                [score,new_position]=sstress_score(geophone_position,D_augment,d);
                score
                if(score<s_best)
                    s_best=score;
