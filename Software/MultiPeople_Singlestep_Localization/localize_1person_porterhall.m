...
load('./../PorterLab_011719/PorterLab_011719_sj_s_2.mat');
t=data(1,:); % time 
data=data(2:5,:);
data(2,:)=-data(2,:);
...
for i=1:length(stepEventsIdx)
        h=rectangle('Position',[stepStartIdxArray(i),-mag,...
...
data_test=data(:,stepStartIdxArray(num_step):stepStopIdxArray(num_step+1));
...
filename='./result_1person/trial5.mat';
load(filename);
